...
class YOLOHandler:
    ...
    def get_detection_summary(self, result_info):
        ...
        return {
            ...
            "has_vehicle": any(
                d["class_name"] in ["car", "truck", "van", "motorcycle"]
                for d in detections
            ),
    ...
    def filter_detections(
        self, result_info, min_confidence=0.5, classes_of_interest=None
    ):
        ...
        for detection in detections:
            ...
            if (
                classes_of_interest
                and detection["class_name"] not in classes_of_interest
            ):
                continue
