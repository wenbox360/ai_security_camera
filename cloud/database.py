...
class Device(Base):
    ...
    # Device credentials are one-way digests. The plaintext key is returned once
    # by the management command and must never be persisted.
    ...
    events = relationship(
        "SecurityEvent", back_populates="device", cascade="all, delete-orphan"
    )
...
class SecurityEvent(Base):
    ...
    )  # "person_detected", "motion", "unknown_face"
